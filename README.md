...
A web and data analytics based project. There is a website which is deployed on Render and Real time data in exported to Google Sheets. Then Analysis is done on this real time data.<br>
...
🔗 www.linkedin.com/in/chetna-dadwal<br>
